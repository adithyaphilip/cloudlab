...
parallel-ssh -t 0 -x "-o StrictHostKeyChecking=no -i ~/.ssh/id_rsa" -h hosts_file_pssh "cd cloudlab; git pull; bash startup.sh; sudo python3 main.py $1 2>&1 | sudo tee main_combined.out"
